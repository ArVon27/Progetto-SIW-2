package it.uniroma3.SW.authentication;
...
import static it.uniroma3.SW.spring.model.Credentials.ADMIN_ROLE;
...
public class AuthConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/", "/index","/inizio", "/base", "/login", "/register", "/css/**", "/images/**", "/layout/**").permitAll()
